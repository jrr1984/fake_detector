...
steg_root.state('zoomed')
steg_root.iconbitmap('c:/users/juanr/downloads/logo_lec.ico')
image = None
t1 = None
t2 = None
pImage = None
...
openImageButton = Button(bottomFrame, text="Open Image", command=select_image, font="Helvetica 14 bold",
                         bg="PeachPuff2")
openImageButton.pack(side=LEFT)

# Footer

footerLabel = Label(steg_root, height="2", bg="grey1", width="100", fg="white",
                    text="StegoSuite v0.1 BETA, Developed under Project OFTK\n Contributors: Rajan Kumar Shah")
